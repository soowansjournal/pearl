...
# 5) Read/Analyze the results file - OP vs MA
    # For each row
    # If quality rep
    # Subtract the StartTime-EndTime columns
    # Sum the time
    # If not quality rep
    # Timer = 0 
...
for game_ind in range(len(op_games)):
    ...
    for mmdd_p in mmdd_p_all:
        ...
        # 3) Go through Ajmal's Results File
        folder_path = '/Users/soowan/Documents/PEARL/Data/Data_OB2/Results_Ajmal/STS/Five/Cleaned_20230625/'
    ...
    df_game.to_csv(rf'/Users/soowan/Documents/PEARL/Data/Data_OB2/Results_Soowan/STS/FIVE/2023-{op_games[game_ind]}-TIMER.csv', encoding = 'utf-8-sig')
