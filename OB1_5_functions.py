...
def table_vel(op_vel, ma_vel, diff_vel, per_vel, rightorleft, maxormean, participant, order = 'NA'):
  ...
  if order != 'NA':
    ...
    vel_table = pd.DataFrame([single_vals], columns = col, index = participant)
