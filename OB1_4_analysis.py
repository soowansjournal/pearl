...
from OB1_4_functions import * # todo import other modules
...
mmdd_p_all = ['0221_P01', '0314_P02', '0314_P03', '0601_P28']
...
for game_ind in range(len(op_games)):
    ...
    for mmdd_p in mmdd_p_all:
        ...
        # DOWNLOAD the reach results --> paste into data results
        reach_re.to_csv(rf'/Users/soowan/Documents/PEARL/Data/Data_OB1/4_Reach/{op_games[game_ind]}/2023{mmdd_p[:4]}-{mmdd_p[-3:]}-{op_games[game_ind]}-reach.csv', encoding = 'utf-8-sig') 
