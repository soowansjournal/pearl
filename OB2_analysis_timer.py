...
for game_ind in range(len(op_games)):
    ...
    for mmdd_p in mmdd_p_all:
        ...
        # 3) Go through Ajmal's Results File
        folder_path = '/Users/soowan/Documents/PEARL/Data/Data_OB2/Ajmal_Results'
    ...
    # df_game.to_csv(rf'/Users/soowan/Documents/PEARL/Data/Data_OB2/Soowan_Results/2023-{op_games[game_ind]}-TIMER.csv', encoding = 'utf-8-sig')
